 ...
 *
 *    Keep the ElementsDojutsumix object in this class and all calls to this object
...
public class Dojutsumix {
	...
	@Mod.Instance(MODID)
	public static Dojutsumix instance;
	public ElementsDojutsumix elements = new ElementsDojutsumix();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsDojutsumix.GuiHandler());
